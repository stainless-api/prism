...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @stainless-api/prism-http-server bumped from 5.15.0 to 5.16.0
...
* The following workspace dependencies were updated
  * dependencies
    * @stainless-api/prism-core bumped from 5.11.2 to 5.12.0
    * @stainless-api/prism-http bumped from 5.14.0 to 5.15.0
    * @stainless-api/prism-http-server bumped from 5.14.0 to 5.15.0

## [5.14.0](https://github.com/stainless-api/prism/compare/v5.13.3...v5.14.0) (2025-06-26)
...
* The following workspace dependencies were updated
  * dependencies
    * @stainless-api/prism-core bumped from 5.11.1 to 5.11.2
    * @stainless-api/prism-http bumped from 5.13.3 to 5.14.0
    * @stainless-api/prism-http-server bumped from 5.13.3 to 5.14.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @stoplight/prism-http bumped from 5.13.1 to 5.13.2
    * @stoplight/prism-http-server bumped from 5.13.1 to 5.13.2

## [5.13.1](https://github.com/stainless-api/prism/compare/v5.13.0...v5.13.1) (2025-06-05)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @stoplight/prism-http bumped from 5.13.0 to 5.13.1
    * @stoplight/prism-http-server bumped from 5.13.0 to 5.13.1
